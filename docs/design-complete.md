...
| `--line-ui` | ボタン・入力欄・チップなど操作部品の枠線（2026-09-23 追加、decisions D-43） | #7a7a7a（和紙3色の上で 3.15〜3.81:1） |
...
| 最小の文字・操作 | 文字は14px以上（吹き出し・注記・信頼マークも）、押せる部品は44×44px以上（デジタル庁デザインシステムの基準。decisions D-43） |
